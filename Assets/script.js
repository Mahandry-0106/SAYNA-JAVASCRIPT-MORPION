...
const chose = document.getElementsByClassName('choix');
const play = document.getElementsByClassName('play');
const win = document.getElementsByClassName('result');
...
let result = [];//resultat du joueur
let resultCPU = [];//resultat de l'ordiateur
let resultCas = [//possibilte de victoire
    [1,2,3],
    [4,5,6],
    [7,8,9],
    [1,4,7],
...
let score = 0;//Score initialedu cpu
let scorem = 0;//Score initiale du joueur
//Choix de joueur
 ...
 * Ou 'O' est alinge => Vous perdez et "Defeat" s'affiche sur l'ecran avec un boutton 'Again' pour recommencer le jeu
 * Sinon , il y a 3 'X' alignés => vous gagnez et "Win" s'affiche sur l'ecran avec un boutton 'Again' pour recommencer le jeu
 *  le score s'affiche sur 'YOU' or 'CPU' par rapport au resultat,
...
function viewResultat(){
    ...
    //Conditon pour voir si cpu gagne
...
function addElement1(){
    if(id[0].textContent !== ''){
        ...
        result.push(ref[0]);
        viewResultat();
        if(id[1].textContent === `${turn}` && id[2].textContent === ''){
            id[2].innerHTML = `${turn2}`;
            resultCPU.push(ref[2]);
        }
        else if(id[2].textContent === `${turn}` && id[1].textContent === ''){
            id[1].innerHTML = `${turn2}`;
            resultCPU.push(ref[1]);
        }
        else if(id[3].textContent === `${turn}` && id[6].innerHTML === ''){
            id[6].innerHTML = `${turn2}`;
            resultCPU.push(ref[6]);
        }
        else if(id[4].textContent === `${turn}` && id[8].textContent === ''){
            id[8].innerHTML = `${turn2}`;
            resultCPU.push(ref[8]);
        }
        else if(id[6].textContent === `${turn}` && id[3].textContent === ''){
            id[3].innerHTML = `${turn2}`;
            resultCPU.push(ref[3]);
        }
        else if(id[8].textContent === `${turn}` && id[4].te === ''){
        ...
        else{//CPU choisi une case au hasard
            hasardCPU();
            }
        }
};
function addElement2(){
    if(id[1].textContent !== ''){
        ...
        result.push(ref[1]);
        viewResultat();
        if(id[0].textContent === `${turn}` && id[2].innerHTML === ''){
            id[2].innerHTML = `${turn2}`;
            resultCPU.push(ref[2]);
        }
        else if(id[2].textContent === `${turn}` && id[1].innerHTML === ''){
            id[0].innerHTML = `${turn2}`;
            resultCPU.push(ref[0]);
        }
        else if(id[4].textContent === `${turn}` && id[7].innerHTML === ''){
...
function addElement3(){
    if(id[2].textContent !== ''){
        ...
        result.push(ref[2]);
        viewResultat();
        if(id[0].textContent === `${turn}` && id[1].innerHTML === ''){//
            id[1].innerHTML = `${turn2}`;
            resultCPU.push(ref[1]);
        }
        else if(id[1].textContent === `${turn}` && id[0].innerHTML === ''){//
            id[0].innerHTML = `${turn2}`;
            resultCPU.push(ref[0]);
        }
        else if(id[4].textContent === `${turn}` && id[6].innerHTML === ''){//
            id[6].innerHTML = `${turn2}`;
            resultCPU.push(ref[6]);
        }
        else if(id[5].textContent === `${turn}` && id[8].innerHTML === ''){//
            id[8].innerHTML = `${turn2}`;
            resultCPU.push(ref[8]);
        }
        else if(id[6].textContent === `${turn}` && id[4].innerHTML === ''){//
            id[4].innerHTML = `${turn2}`;
            resultCPU.push(ref[4]);
        }
        else if(id[8].textContent === `${turn}` && id[5].innerHTML === ''){//
...
function addElement4(){
    if(id[3].textContent !== ''){
        ...
        result.push(ref[3]);
        viewResultat();
        if(id[0].textContent === `${turn}` && id[6].innerHTML === ''){
            id[6].innerHTML = `${turn2}`;
            resultCPU.push(ref[6]);
        }
        else if(id[4].textContent === `${turn}` && id[5].innerHTML === ''){
            id[5].innerHTML = `${turn2}`;
            resultCPU.push(ref[5]);
        }
        else if(id[5].textContent === `${turn}` && id[4].innerHTML === ''){
            id[4].innerHTML = `${turn2}`;
            resultCPU.push(ref[4]);
        }
        else if(id[6].textContent === `${turn}` && id[0].innerHTML === ''){
            id[0].innerHTML = `${turn2}`;
            resultCPU.push(ref[0]);
        }
        else if(id[4].textContent === ''){
...
function addElement5(){
    if(id[4].textContent !== ''){
        ...
        result.push(ref[4]);
        viewResultat();
        if(id[0].textContent === `${turn}` && id[8].innerHTML === ''){
            id[8].innerHTML = `${turn2}`;
            resultCPU.push(ref[8]);
        }
        else if(id[1].textContent === `${turn}` && id[7].textContent === ''){
            id[7].innerHTML = `${turn2}`;
            resultCPU.push(ref[7]);
        }
        else if(id[2].textContent === `${turn}` && id[6].textContent === ''){
            id[6].innerHTML = `${turn2}`;
            resultCPU.push(ref[6]);
        }
        else if(id[2].textContent === `${turn}` && id[6].textContent !== '' && id[8].textContent === ''){
            id[8].innerHTML = `${turn2}`;
            resultCPU.push(ref[8]);
        }
        else if(id[3].textContent === `${turn}` && id[5].textContent === ''){
            id[5].innerHTML = `${turn2}`;
            resultCPU.push(ref[5]);
        }
        else if(id[5].textContent === `${turn}` && id[3].textContent === ''){
            id[3].innerHTML = `${turn2}`;
            resultCPU.push(ref[3]);
        }
        else if(id[6].textContent === `${turn}` && id[2].textContent === ''){
            id[2].innerHTML = `${turn2}`;
            resultCPU.push(ref[2]);
        }
        else if(id[7].textContent === `${turn}` && id[1].textContent === ''){
            id[1].innerHTML = `${turn2}`;
            resultCPU.push(ref[1]);
        }
        else if(id[8].textContent === `${turn}` && id[0].textContent === ''){
            id[0].innerHTML = `${turn2}`;
            resultCPU.push(ref[0]);
        }
        else if(id[8].textContent === `${turn}` && id[0].textContent === `${turn2}` && id[2].textContent === ''){
            id[2].innerHTML = `${turn2}`;
            resultCPU.push(ref[2]);
        }
        else{
...
function addElement6(){
    if(id[5].textContent !== ''){
        ...
        result.push(ref[5]);
        viewResultat();
        if(id[0].textContent === `${turn2}` && id[6].textContent === `${turn2}` && id[3].textContent === ''){
            id[3].innerHTML = `${turn2}`;
            resultCPU.push(ref[3]);
        }
        else if(id[2].textContent === `${turn}` && id[8].innerHTML === ''){
            id[8].innerHTML = `${turn2}`;
            resultCPU.push(ref[8]);
        }
        else if(id[3].textContent === `${turn}` && id[4].innerHTML === ''){
            id[4].innerHTML = `${turn2}`;
            resultCPU.push(ref[4]);
        }
        else if(id[4].textContent === `${turn}` && id[3].innerHTML === ''){
            id[3].innerHTML = `${turn2}`;
            resultCPU.push(ref[3]);
        }
        else if(id[8].textContent === `${turn}` && id[2].innerHTML === ''){
            id[2].innerHTML = `${turn2}`;
            resultCPU.push(ref[2]);
        }
        else if(id[4].textContent === ''){
        ...
        else{//CPU choisi au hasard une case 
            hasardCPU();
        }
    }
};
function addElement7(){
    if(id[6].textContent !== ''){
        ...
        result.push(ref[6]);
        viewResultat();
        if(id[0].textContent === `${turn}` && id[3].innerHTML === ''){
            id[3].innerHTML = `${turn2}`;
            resultCPU.push(ref[3]);
        }
        else if(id[2].textContent === `${turn}` && id[4].innerHTML === ''){
            id[4].innerHTML = `${turn2}`;
            resultCPU.push(ref[4]);
        }
        else if(id[3].textContent === `${turn}` && id[0].innerHTML === ''){
            id[0].innerHTML = `${turn2}`;
            resultCPU.push(ref[0]);
        }
        else if(id[4].textContent === `${turn}` && id[2].innerHTML === ''){
            id[2].innerHTML = `${turn2}`;
            resultCPU.push(ref[2]);
        }
        else if(id[7].textContent === `${turn}` && id[8].innerHTML === ''){
            id[8].innerHTML = `${turn2}`;
            resultCPU.push(ref[8]);
        }
        else if(id[8].textContent === `${turn}` && id[7].innerHTML === ''){
            id[7].innerHTML = `${turn2}`;
            resultCPU.push(ref[7]);
        }
...
function addElement8(){
    if(id[7].textContent !== ''){
        ...
        result.push(ref[7]);
        viewResultat();
        if(id[1].textContent === `${turn}` && id[4].innerHTML === ''){
            id[4].innerHTML = `${turn2}`;
            resultCPU.push(ref[4]);
        }
        else if(id[4].textContent === `${turn}` && id[1].innerHTML === ''){
            id[1].innerHTML = `${turn2}`;
            resultCPU.push(ref[1]);
        }
        else if(id[6].textContent === `${turn}` && id[8].innerHTML === ''){
            id[8].innerHTML = `${turn2}`;
            resultCPU.push(ref[8]);
        }
        else if(id[8].textContent === `${turn}` && id[6].innerHTML === ''){
            id[6].innerHTML = `${turn2}`;
            resultCPU.push(ref[6]);
        }
        else if(id[4].textContent === `${turn}` && id[1].textContent !== '' && id[3].textContent === ''){
            id[3].innerHTML = `${turn2}`;
            resultCPU.push(ref[3]);
        }
        else if(id[4].textContent === ''){
...
function addElement9(){
    if(id[8].textContent !== ''){
        ...
        result.push(ref[8]);
        viewResultat();
        if(id[0].textContent === `${turn}` && id[4].innerHTML === ''){
            id[4].innerHTML = `${turn2}`;
            resultCPU.push(ref[4]);
        }
        else if(id[2].textContent === `${turn}` && id[5].innerHTML === ''){
            id[5].innerHTML = `${turn2}`;
            resultCPU.push(ref[5]);
        }
        else if(id[4].textContent === `${turn}` && id[0].innerHTML === ''){
            id[0].innerHTML = `${turn2}`;
            resultCPU.push(ref[0]);
        }
        else if(id[5].textContent === `${turn}` && id[2].innerHTML === ''){
            id[2].innerHTML = `${turn2}`;
            resultCPU.push(ref[2]);
        }
        else if(id[6].textContent === `${turn}` && id[7].innerHTML === ''){
            id[7].innerHTML = `${turn2}`;
            resultCPU.push(ref[7]);
        }
        else if(id[7].textContent === `${turn}` && id[6].innerHTML === ''){
            id[6].innerHTML = `${turn2}`;
            resultCPU.push(ref[6]);
        }
        else if(id[4].textContent === ''){
        ...
        else{//CPU choisi au hasard ue case
            hasardCPU();
        }
    }
};
